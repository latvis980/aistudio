      ...
      {LANGUAGES.map(({ code, label }) => (
        <fieldset key={code} className="p-4 bg-white border border-gray-200 rounded-lg space-y-3 mb-4">
          ...
          <div>
            ...
            <input
              type="text"
              value={(item as Record<string, unknown>)[`title_${code}`] as string || ''}
          ...
          <div>
            ...
            <textarea
              value={(item as Record<string, unknown>)[`description_${code}`] as string || ''}
          ...
          <div>
            ...
            <textarea
              value={(item as Record<string, unknown>)[`body_${code}`] as string || ''}
